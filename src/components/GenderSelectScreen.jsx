...
const OPTIONS = [
  {
    ...
    icon: '♂',
    label: 'Masculino',
    program: 'Massa · Queima',
    desc: 'PPL com reps de hipertrofia, descanso controlado e gasto calórico maior.',
    color: '#4cc9f0',
  ...
  },
  {
    ...
    icon: '♀',
    label: 'Feminino',
    program: 'Glúteos · Queima',
    desc: 'PPL com foco em glúteos, definição e densidade para hipertrofia.',
    color: '#c084fc',
